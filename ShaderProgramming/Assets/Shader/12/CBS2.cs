...
public class CBS2 : MonoBehaviour
{
    ...
    [SerializeField]
    Vector3 range = new Vector3(100, 0, 100);

    Mesh combinedMesh_;
    ComputeBuffer computeBuffer_;
    int emitKernel_;
    List<Material> marshals_ = new List<Material>();
    int numPerMesh_;
    int meshNum_;
    ...
    private void OnEnable()
    {
        ...
        computeShader.Dispatch(initKernel, maxInstanceNum / 32, 1, 1);
    }
